...
class _TelaNotasState extends State<TelaNotas>
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                spacing: 6,
                runSpacing: 6,
                children: notasOrd.map((n) => _buildChipNota(n)).toList(),
              ),
  ...
  Widget _buildCardRisco(_Desempenho d) {
    ...
    final notaNec = ((_mediaMinPadrao * (pesoAtual + 1)) - somaAtual).clamp(
      0,
      10,
    );
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Média atual: ${media.toStringAsFixed(1)}',
                  style: const TextStyle(
                    fontSize: 12,
    ...
    return Column(
      ...
      children: [
        ...
        ...comNotas.map((d) {
          ...
          final pesoAtual = d.notas.fold(0.0, (s, n) => s + n.peso);
          const mediaAlvo = 7.0;
          final notaNec = ((mediaAlvo * (pesoAtual + 1)) - somaAtual).clamp(
            0,
            10,
          );
            ...
            child: Row(
              children: [
                ...
                Column(
                  ...
                  children: [
                    Text(
                      notaNec <= 0 ? '✅' : notaNec.toStringAsFixed(1),
                      style: TextStyle(
                        fontSize: 18,
                        fontWeight: FontWeight.w900,
                        color: notaNec <= 0 ? const Color(0xFF10B981) : cor,
                      ),
                    ),
                    if (notaNec > 0)
                      const Text(
  ...
  void _calcularSimulador() {
    try {
      ...
      final notaNec = (mediaAlvo * totalPesos - somaAtual) / pesoProxima;
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(
                'Matérias ordenadas por desempenho',
                style: TextStyle(color: Colors.white70, fontSize: 12),
              ),
            ],
          ),
  ...
  Widget _buildItemRanking(_Desempenho d, int index) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(16),
        border: Border.all(
          color: isTop3 ? cor.withValues(alpha: 0.25) : const Color(0xFFF1F5F9),
        ),
        boxShadow: [
          BoxShadow(
      ...
      child: Row(
        children: [
          SizedBox(
            ...
            child: Center(
              child: isTop3
                  ? Text(medalhas[index], style: const TextStyle(fontSize: 22))
                  : Text(
                      '${index + 1}º',
                      style: const TextStyle(
                        fontSize: 13,
